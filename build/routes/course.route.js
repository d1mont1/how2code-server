...
courseRouter.put('/add-reply', user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)('admin', 'mentor'), course_controller_1.addReplyToReview);
